...
const sidebarMenus = computed(() => {
  if (userRole.value === 'admin') {
    return [
      { path: '/dashboard', title: '仪表板', icon: 'Monitor' },
      { path: '/students', title: '学生管理', icon: 'User' },
      { path: '/teachers', title: '教师管理', icon: 'Avatar' },
      { path: '/courses', title: '课程管理', icon: 'Reading' },
      { path: '/grades', title: '成绩管理', icon: 'DocumentChecked' },
      { path: '/system-settings', title: '系统设置', icon: 'Tools' }
    ]
  } else if (userRole.value === 'teacher') {
    return [
      { path: '/teacher/dashboard', title: '仪表板', icon: 'Monitor' },
      { path: '/teacher/courses', title: '课程管理', icon: 'Reading' },
      { path: '/teacher/grades', title: '成绩管理', icon: 'DocumentChecked' }
    ]
  } else {
    return [
      { path: '/student/dashboard', title: '仪表板', icon: 'Monitor' },
      { path: '/student/courses', title: '我的课程', icon: 'Reading' },
      { path: '/student/grades', title: '我的成绩', icon: 'DocumentChecked' }
    ]
  }
})
